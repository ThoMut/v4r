...
//            grouped_change.first.push_back( XMLChange("cfg/hv_config.xml", "resolution_mm_", {"10"}, false ) );
//            grouped_change.first.push_back( XMLChange("cfg/hv_config.xml", "resolution_mm_", {"12"}, false ) );
...
//        grouped_change.first.push_back( XMLChange("cfg/multipipeline_config.xml", "cg_size_", {"0.03"}, false ) );
//        grouped_change.second = local_search_is_okay;
//        grouped_changes.push_back( grouped_change );
    }
